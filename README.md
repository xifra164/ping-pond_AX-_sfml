...
int main() {
	...
	bal.setOutlineColor(Color::White);
	...
	while (window.isOpen())
	{
		...
		case PLAYING: {
		   ...
		   //paddle 1 grenzen
			...
			// Teken de gestippelde cirkel in het midden
			float centerY = windowHeight / 2.0f;
			int numCircleSegments = 60;
			float angleStep = 360.0f / numCircleSegments;
			...
			break; // Einde van PLAYING case
					...
					GAME_OVER: {
						...
						messageText.setFillColor(Color::Blue); // Kleur voor Game Over
						messageText.setCharacterSize(80);
